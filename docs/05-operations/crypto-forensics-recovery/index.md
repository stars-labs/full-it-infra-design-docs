...
| 章节 | 内容 |
| :--- | :--- |
| [取证工具栈](./01-toolkit) | 详细的工具安装、配置与使用说明 |
| [目标文件与特征](./02-target-patterns) | 钱包文件位置、助记词搜索模式、私钥特征 |
| [取证操作流程](./03-forensics-sop) | 从接受到销毁的完整 SOP |
| [安全与合规](./04-security-compliance) | 写保护、证据链、数据销毁规范 |
